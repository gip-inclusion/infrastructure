...
| Name | Version |
|------|---------|
| <a name="provider_scaleway.tmp"></a> [scaleway.tmp](#provider\_scaleway.tmp) | 2.69.0 |

## Modules

| Name | Source | Version |
|------|--------|---------|
| <a name="module_dns-communaute"></a> [dns-communaute](#module\_dns-communaute) | ../../../../_modules/dns/records/terraform | n/a |
